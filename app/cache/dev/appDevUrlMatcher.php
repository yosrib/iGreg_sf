    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (rtrim($pathinfo, '/') === '/admin') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'admin_admin_index');
                }
        ...
        // front_front_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'front_front_homepage')), array (  '_controller' => 'Front\\FrontBundle\\Controller\\DefaultController::indexAction',));
        }
